...
<section class="flex flex-col w-full max-w-3xl" id="about">
  ...
  <div class="flex flex-col items-start w-full">
    ...
    <a href="mailto:${data.email}" class="group mt-6 inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:-translate-y-1 hover:shadow-lg active:scale-95 transition-all duration-300 font-bold">
      Get in touch
