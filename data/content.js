...
prologue: {
  ...
  socials: [
    {
      colorClass: "bg-macchiato-surface0 text-macchiato-text hover:bg-macchiato-surface1",
      label: "GitHub",
    ...
    {
      colorClass: "bg-macchiato-sapphire/20 text-macchiato-sapphire hover:bg-macchiato-sapphire/30",
      label: "LinkedIn",
