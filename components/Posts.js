...
<section class="flex flex-col gap-space-lg scroll-mt-20" id="posts">
  ...
  <div class="flex flex-col gap-space-xs">
    ${data.articles.map(article => `
      <a class="p-space-sm -mx-space-sm rounded-xl hover:bg-macchiato-surface0/70 flex flex-col gap-1 transition-all group" href="${article.url}" target="_blank" rel="noopener noreferrer">
