...
<section class="flex scroll-mt-20 flex-col" id="contact">
  ...
  <div class="flex flex-col">
    ...
    <div class="flex">
      <a href="mailto:${data.email}" class="magnetic-btn group inline-flex items-center px-6 py-3 rounded-xl bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:shadow-lg active:scale-95 transition-shadow duration-300 font-bold">
