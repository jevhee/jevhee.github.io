...
<header class="w-full flex items-center justify-end p-6 md:p-10 bg-transparent transition-colors duration-300">
  ...
  <button style="view-transition-name: theme-toggle;" aria-label="Toggle Theme" class="theme-toggle-btn group relative w-9 h-9 md:w-10 md:h-10 rounded-full bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:opacity-90 active:scale-95 flex items-center justify-center transition-all duration-700 transform dark:rotate-[360deg] outline-none overflow-hidden shrink-0">
