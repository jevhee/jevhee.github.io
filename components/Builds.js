      ...
      ${data.projects
        ...
        <li class="relative text-base text-macchiato-text border-b border-dashed border-macchiato-surface2 sm:border-none last:border-none">
          ...
          <div class="flex gap-3 shrink-0 mt-1 sm:mt-0 mb-1 sm:mb-0 items-center">
            ${
              project.links?.code
                ? `<a href="${project.links.code}" target="_blank" class="magnetic-btn group relative flex items-center justify-center w-9 h-9 rounded-full bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:shadow-lg active:scale-95 transition-all duration-300" title="Source Code">
                <span class="magnetic-inner flex items-center justify-center pointer-events-none transition-transform duration-100 ease-out">
            ...
            ${
              project.links?.appStore
                ? `<a href="${project.links.appStore}" target="_blank" class="magnetic-btn group relative flex items-center justify-center w-9 h-9 rounded-full bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:shadow-lg active:scale-95 transition-all duration-300" title="App Store">
                <span class="magnetic-inner flex items-center justify-center pointer-events-none transition-transform duration-100 ease-out">
            ...
            ${
              project.links?.playStore
                ? `<a href="${project.links.playStore}" target="_blank" class="magnetic-btn group relative flex items-center justify-center w-9 h-9 rounded-full bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:shadow-lg active:scale-95 transition-all duration-300" title="Play Store">
                <span class="magnetic-inner flex items-center justify-center pointer-events-none transition-transform duration-100 ease-out">
