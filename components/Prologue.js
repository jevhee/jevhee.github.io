...
<section class="flex flex-col w-full max-w-3xl" id="about">
  ...
  <div class="flex flex-col items-start w-full">
    ...
    <a href="mailto:${data.email}" class="magnetic-btn group mt-6 inline-flex items-center px-6 py-3 rounded-xl bg-macchiato-blue dark:bg-macchiato-yellow text-macchiato-base dark:text-macchiato-base hover:shadow-lg active:scale-95 transition-shadow duration-300 font-bold">
      <span class="magnetic-inner flex items-center gap-2.5 pointer-events-none transition-transform duration-100 ease-out">
        Get in touch
